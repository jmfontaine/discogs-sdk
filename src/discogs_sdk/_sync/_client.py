    ...
    def __init__(
        ...
        *,
        ...
        if http_client is not None:
            ...
            try:
                from hishel import SyncSqliteStorage  # ty: ignore[unresolved-import]
                from hishel.httpx import SyncCacheClient  # ty: ignore[unresolved-import]
            except ImportError:
                raise ImportError(
            ...
            self._http_client = SyncCacheClient(storage=storage, headers=self._build_headers(), timeout=self.timeout)
