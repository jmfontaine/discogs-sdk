...
class CollectionFolders(AsyncAPIResource):
    ...
    async def create(self, *, name: str) -> CollectionFolder:
        response = await self._post(self._base_path(), json={"name": name})
...
class CollectionReleaseRef:
    ...
    def __init__(self, client: AsyncDiscogs, username: str, release_id: int) -> None:
        self._client = client
        self._username = username
        self._release_id = release_id
...
class CollectionReleases(AsyncAPIResource):
    def __init__(self, client, username: str) -> None:
        super().__init__(client)
        self._username = username
...
class CollectionFields(AsyncAPIResource):
    def __init__(self, client, username: str) -> None:
        super().__init__(client)
        self._username = username
...
class CollectionValueResource(AsyncAPIResource):
    def __init__(self, client, username: str) -> None:
        super().__init__(client)
        self._username = username
